...
<head>
    ...
    <link rel="stylesheet" href="../../publico/css/credenciales_incorrectas.css"> <!-- Ruta a los estilos -->
</head>
<body>
    <main class="contenedor-error">
        ...
        <a href="http://localhost:3000/app/vistas/login.html" class="boton-inicio">Intentarlo de nuevo</a>
    </main>
</body>
</html>
